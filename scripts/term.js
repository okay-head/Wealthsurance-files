...
$("#page3Form").validate({
   ...
   rules: {
      tepg2e1: {
       ...
       tepg2e2c1: {number: true,min:0},
       tepg2e3c1: {number: true,min:0},
       tepg2e4c1: {number: true,min:0},
       tepg2e5c1: {number: true,min:0},
       tepg2e6c1: {number: true,min:0},
       tepg2e7c1: {number: true,min:0},
       tepg2e8c1: {number: true,min:0},
       ...
       tepg2e2c3: {digits: true,min:0},
       tepg2e3c3: {digits: true,min:0},
       tepg2e4c3: {digits: true,min:0},
       tepg2e5c3: {digits: true,min:0},
       tepg2e6c3: {digits: true,min:0},
       tepg2e7c3: {digits: true,min:0},
       tepg2e8c3: {digits: true,min:0},
   },
   messages: {
      tepg2e1: {
   ...
   tepg2e2c1:{min:"Value cannot be negative"},
   tepg2e3c1:{min:"Value cannot be negative"},
   tepg2e4c1:{min:"Value cannot be negative"},
   tepg2e5c1:{min:"Value cannot be negative"},
   tepg2e6c1:{min:"Value cannot be negative"},
   tepg2e7c1:{min:"Value cannot be negative"},
   tepg2e8c1:{min:"Value cannot be negative"},
   ...
   tepg2e2c3:{min:"Value should be greater than 0",digits:"Please enter only positive integers"},
   tepg2e3c3:{min:"Value should be greater than 0",digits:"Please enter only positive integers"},
   tepg2e4c3:{min:"Value should be greater than 0",digits:"Please enter only positive integers"},
   tepg2e5c3:{min:"Value should be greater than 0",digits:"Please enter only positive integers"},
   tepg2e6c3:{min:"Value should be greater than 0",digits:"Please enter only positive integers"},
   tepg2e7c3:{min:"Value should be greater than 0",digits:"Please enter only positive integers"},
   tepg2e8c3:{min:"Value should be greater than 0",digits:"Please enter only positive integers"},
   },
});
...
$("#page4Form").validate({
   ...
   rules: {
      tepg3e1: {
       ...
       tepg3e2c1: {number: true,min:0},
       tepg3e3c1: {number: true,min:0},
       tepg3e4c1: {number: true,min:0},
       tepg3e5c1: {number: true,min:0},
       tepg3e6c1: {number: true,min:0},
       
       tepg3e2c2: {digits: true,min:0},
       tepg3e3c2: {digits: true,min:0},
       tepg3e4c2: {digits: true,min:0},
       tepg3e5c2: {digits: true,min:0},
       tepg3e6c2: {digits: true,min:0},
   },
   messages: {
      tepg3e1: {
          required: "This field is required" ,
   ...
   tepg3e2c1:{min:"Value cannot be negative"},
   tepg3e3c1:{min:"Value cannot be negative"},
   tepg3e4c1:{min:"Value cannot be negative"},
   tepg3e5c1:{min:"Value cannot be negative"},
   tepg3e6c1:{min:"Value cannot be negative"},

   tepg3e2c2:{min:"Value cannot be negative",digits:"Please only enter positive integers"},
   tepg3e3c2:{min:"Value cannot be negative",digits:"Please only enter positive integers"},
   tepg3e4c2:{min:"Value cannot be negative",digits:"Please only enter positive integers"},
   tepg3e5c2:{min:"Value cannot be negative",digits:"Please only enter positive integers"},
   tepg3e6c2:{min:"Value cannot be negative",digits:"Please only enter positive integers"},
   },
});
...
$('#teRecalcForm').validate({
   ...
   rules: {
      ...
      teresultp1r1e1: {number: true,min:0},
      teresultp1r2e1: {number: true,min:0},
      teresultp1r3e1: {number: true,min:0},
      teresultp1r4e1: {number: true,min:0},
      teresultp1r5e1: {number: true,min:0},
      teresultp1r6e1: {number: true,min:0},
      teresultp1r7e1: {number: true,min:0},
      ...
      teresultp1r1e3: {digits: true,min:0},
      teresultp1r2e3: {digits: true,min:0},
      teresultp1r3e3: {digits: true,min:0},
      teresultp1r4e3: {digits: true,min:0},
      teresultp1r5e3: {digits: true,min:0},
      teresultp1r6e3: {digits: true,min:0},
      teresultp1r7e3: {digits: true,min:0},
      ...
      teresultp2r1e1: {number: true,min:0},
      teresultp2r2e1: {number: true,min:0},
      teresultp2r3e1: {number: true,min:0},
      teresultp2r4e1: {number: true,min:0},
      teresultp2r5e1: {number: true,min:0},

      teresultp2r1e2: {digits: true,min:0},
      teresultp2r2e2: {digits: true,min:0},
      teresultp2r3e2: {digits: true,min:0},
      teresultp2r4e2: {digits: true,min:0},
      teresultp2r5e2: {digits: true,min:0},
   ...
   teresultp1r1e1:{min:"Value cannot be negative"},
   teresultp1r2e1:{min:"Value cannot be negative"},
   teresultp1r3e1:{min:"Value cannot be negative"},
   teresultp1r4e1:{min:"Value cannot be negative"},
   teresultp1r5e1:{min:"Value cannot be negative"},
   teresultp1r6e1:{min:"Value cannot be negative"},
   teresultp1r7e1:{min:"Value cannot be negative"},
   ...
   teresultp1r1e3:{min:"Value cannot be negative",digits:"Please enter only positive integers"},
   teresultp1r2e3:{min:"Value cannot be negative",digits:"Please enter only positive integers"},
   teresultp1r3e3:{min:"Value cannot be negative",digits:"Please enter only positive integers"},
   teresultp1r4e3:{min:"Value cannot be negative",digits:"Please enter only positive integers"},
   teresultp1r5e3:{min:"Value cannot be negative",digits:"Please enter only positive integers"},
   teresultp1r6e3:{min:"Value cannot be negative",digits:"Please enter only positive integers"},
   teresultp1r7e3:{min:"Value cannot be negative",digits:"Please enter only positive integers"},

   // page2
   teresultp2r1e1:{min:"Value cannot be negative"},
   teresultp2r2e1:{min:"Value cannot be negative"},
   teresultp2r3e1:{min:"Value cannot be negative"},
   teresultp2r4e1:{min:"Value cannot be negative"},
   teresultp2r5e1:{min:"Value cannot be negative"},

   teresultp2r1e2:{min:"Value cannot be negative",digits:"Please enter only positive integers"},
   teresultp2r2e2:{min:"Value cannot be negative",digits:"Please enter only positive integers"},
   teresultp2r3e2:{min:"Value cannot be negative",digits:"Please enter only positive integers"},
   teresultp2r4e2:{min:"Value cannot be negative",digits:"Please enter only positive integers"},
   teresultp2r5e2:{min:"Value cannot be negative",digits:"Please enter only positive integers"},
   }
