...
$("#page4Form").validate({
   ...
   rules: {
      ...
      fnapg4e2c1: { number: true, min: 0 },
      fnapg4e3c1: { number: true, min: 0 },
      fnapg4e4c1: { number: true, min: 0 },
      fnapg4e5c1: { number: true, min: 0 },
      fnapg4e6c1: { number: true, min: 0 },
      fnapg4e7c1: { number: true, min: 0 },
      ...
      fnapg4e2c3: { digits: true, min: 0 },
      fnapg4e3c3: { digits: true, min: 0 },
      fnapg4e4c3: { digits: true, min: 0 },
      fnapg4e5c3: { digits: true, min: 0 },
      fnapg4e6c3: { digits: true, min: 0 },
      fnapg4e7c3: { digits: true, min: 0 },
   },
   messages: {
      fnapg4e1: {
         required: "This field is required",
      ...
      fnapg4e2c1: { min: "Value cannot be negative" },
      fnapg4e3c1: { min: "Value cannot be negative" },
      fnapg4e4c1: { min: "Value cannot be negative" },
      fnapg4e5c1: { min: "Value cannot be negative" },
      fnapg4e6c1: { min: "Value cannot be negative" },
      fnapg4e7c1: { min: "Value cannot be negative" },
...
$("#page5Form").validate({
   ...
   rules: {
      ...
      fnapg5e2c1: { number: true, min: 0 },
      fnapg5e3c1: { number: true, min: 0 },
      fnapg5e4c1: { number: true, min: 0 },
      fnapg5e5c1: { number: true, min: 0 },
      fnapg5e6c1: { number: true, min: 0 },

      fnapg5e2c3: { digits: true, min: 0 },
      fnapg5e3c3: { digits: true, min: 0 },
      fnapg5e4c3: { digits: true, min: 0 },
      fnapg5e5c3: { digits: true, min: 0 },
      fnapg5e6c3: { digits: true, min: 0 },
   },
   messages: {
      fnapg5e1: {
         required: "This field is required",
      ...
      fnapg5e2c1: { min: "Value cannot be negative" },
      fnapg5e3c1: { min: "Value cannot be negative" },
      fnapg5e4c1: { min: "Value cannot be negative" },
...
$("#fnaRecalcForm").validate({
   ...
   rules: {
      ...
      fnaresultp1r1e1: { number: true, min: 0 },
      fnaresultp1r2e1: { number: true, min: 0 },
      fnaresultp1r3e1: { number: true, min: 0 },
      fnaresultp1r4e1: { number: true, min: 0 },
      fnaresultp1r5e1: { number: true, min: 0 },
      fnaresultp1r6e1: { number: true, min: 0 },
      ...
      fnaresultp1r1e3: { digits: true, min: 0 },
      fnaresultp1r2e3: { digits: true, min: 0 },
      fnaresultp1r3e3: { digits: true, min: 0 },
      fnaresultp1r4e3: { digits: true, min: 0 },
      fnaresultp1r5e3: { digits: true, min: 0 },
      fnaresultp1r6e3: { digits: true, min: 0 },
      ...
      fnaresultp2r1e1: { number: true, min: 0 },
      fnaresultp2r2e1: { number: true, min: 0 },
      fnaresultp2r3e1: { number: true, min: 0 },
      fnaresultp2r4e1: { number: true, min: 0 },
      fnaresultp2r5e1: { number: true, min: 0 },

      fnaresultp2r1e2: { digits: true, min: 0 },
      fnaresultp2r2e2: { digits: true, min: 0 },
      fnaresultp2r3e2: { digits: true, min: 0 },
      fnaresultp2r4e2: { digits: true, min: 0 },
      fnaresultp2r5e2: { digits: true, min: 0 },
   },
   messages: {
      fnaresultp1r0e1: {
         min: "Debt cannot be negative",
      ...
      fnaresultp1r1e1: { min: "Value cannot be negative" },
      fnaresultp1r2e1: { min: "Value cannot be negative" },
      fnaresultp1r3e1: { min: "Value cannot be negative" },
      fnaresultp1r4e1: { min: "Value cannot be negative" },
      fnaresultp1r5e1: { min: "Value cannot be negative" },
      fnaresultp1r6e1: { min: "Value cannot be negative" },
      ...
      fnaresultp2r2e1: { min: "Value cannot be negative" },
      fnaresultp2r3e1: { min: "Value cannot be negative" },
